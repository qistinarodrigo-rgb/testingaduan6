...
// ========== HANDLE HANTAR ADUAN (DENGAN ALERT DEBUG) ==========
async function handleHantarAduan() {
    // ALERT 1 - Check button function
    alert('1. ✅ Button ditekan!');
    ...
    try {
        ...
        alert(`3. 🖼️ Gambar: ${gambarFile ? 'Ada (' + gambarFile.name + ')' : 'Tiada'}`);
        
        const saveFn = async (gambarData) => {
            // ALERT 4 - Sebelum hantar ke Firebase
            alert('4. ⏳ Sedang hantar ke Firebase...');
            ...
            try {
                ...
                // ALERT 5 - Berjaya
                alert('5. ✅ Berjaya hantar ke Firebase!');
                ...
                // ALERT 6 - Selesai
                alert('6. ✅ Selesai! Senarai aduan dikemaskini.');
                
            } catch (error) {
                // ALERT ERROR - Gagal Firebase
